                                ...
                                <form className="space-y-6" onSubmit={submit}>
                                    ...
                                    <div>
                                        ...
                                        <TextInput
                                            ...
                                            type="text"
                                            value={data.name}
                                            className="w-ful mt-1 block"
                                            isFocused={true}
                                            onChange={(e) => setData('name', e.target.value)}
                                            onErrors={errors.name && <InputError message={errors.name} className="" />}
                                        />
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <TextInput
                                            ...
                                            onErrors={
                                                errors.email && <InputError message={errors.email} className="" />
                                            }
                                        />
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <TextInput
                                            ...
                                            onErrors={
                                                errors.password && <InputError message={errors.password} className="" />
                                            }
                                        />
                                    </div>
                                    ...
                                    <div>
                                        <Button type="submit" disabled={processing} variant="red" className="w-full">
                                            Sign Up
                                        </Button>
                                    </div>
                                </form>
