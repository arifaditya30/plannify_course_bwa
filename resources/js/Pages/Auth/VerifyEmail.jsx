                                ...
                                <form className="space-y-6" onSubmit={submit}>
                                    ...
                                    <div className="mt-4 flex items-center justify-between">
                                        ...
                                        <Link
                                            ...
                                            method="post"
                                            as="button"
                                            className="rounded-sm text-sm text-primary-foreground underline hover:text-foreground focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
                                        >
                                            Logout
                                        </Link>
                                    </div>
