            ...
            <div>
                                            ...
                                            <ul role="list" className="flex flex-1 flex-col gap-y-7">
                                                <li>
                                                    <ul role="list" className="-mx-2 space-y-1">
                                                        ...
                                                        <li>
                                                            <Link
                                                                href="#"
                                                                className="group flex items-center gap-x-3 rounded-md p-3 text-sm font-semibold leading-relaxed hover:bg-gray-100"
                                                            >
                                                                <PiHouse className="h6 w-6 shrink-0 text-foreground" />
                                                                Dashboard
                                                            </Link>
                                                        </li>
                                                        <li>
                                                            <Link
                                                                ...
                                                                className="group flex items-center gap-x-3 rounded-md p-3 text-sm font-semibold leading-relaxed hover:bg-gray-100"
                                                            >
                                                                <PiUser className="h6 w-6 shrink-0 text-foreground" />
                                                                People
                                                            </Link>
                                                        </li>
                                                        <li>
                                                            <Link
                                                                ...
                                                                className="group flex items-center gap-x-3 rounded-md p-3 text-sm font-semibold leading-relaxed hover:bg-gray-100"
                                                            >
                                                                <PiSquaresFour className="h6 w-6 shrink-0 text-foreground" />
                                                                My Task
                                                            </Link>
                                                        </li>
                                                        <li>
                                                            <Link
                                                                ...
                                                                className="group flex items-center gap-x-3 rounded-md p-3 text-sm font-semibold leading-relaxed hover:bg-gray-100"
                                                            >
                                                                <PiLockKeyOpen className="h6 w-6 shrink-0 text-foreground" />
                                                                Logout
                                                            </Link>
                                                        </li>
                                                    </ul>
                                                ...
                                                <li>
                                                    ...
                                                    <div className="flex items-center justify-between">
                                                        <div className="font text-xs font-semibold uppercase leading-relaxed text-foreground">
                                                            Workspaces
                                                        </div>
                                                        <Link>
                                                            <PiPlus className="h5 w-5 text-foreground hover:text-red-500" />
                                                        </Link>
                                                    </div>
                                                    <ul role="list" className="mx-2 mt-2 space-y-1">
                                                        <li>
                                                            <Link
                                                                href="#"
                                                                className="p3 group flex w-full gap-x-3 rounded-md text-sm font-semibold leading-relaxed text-foreground hover:bg-gray-100"
                                                            >
                                                                <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-lg border bg-white text-[0.625rem] font-medium text-foreground">
                                                                    B
                                                                </span>
                ...
                <div className="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
                    <div className="flex grow flex-col gap-y-5 overflow-y-auto border-r border-gray-200 bg-white px-6 dark:border-gray-800 dark:bg-gray-900">
                        ...
                        {/* Sidebar */}
                        <nav className="flex flex-1 flex-col">
                            <ul role="list" list className="flex flex-1 flex-col gap-y-7">
                                <li>
                                    <ul className="-mx-2 space-y-2" role="list">
                                        <li>
                                            <Link
                                                href=""
                                ...
                                <li>
                                    ...
                                    <div className="flex items-center justify-between">
                                        ...
                                        <Link>
                                            <PiPlus className="h4 w-4 text-foreground hover:text-red-500"></PiPlus>
                                        </Link>
                                    </div>
                                ...
                                <li className="-mx-6 mt-auto">
                                    ...
                                    <Link
                                        href="#"
                                        className="flex items-center gap-x-4 px-6 py-3 font-serif text-sm leading-relaxed text-foreground hover:bg-gray-100"
                                    >
                                        <Avatar>
                                            <AvatarFallback>X</AvatarFallback>
                                        </Avatar>
                                        <span>Arif Aditya</span>
                                    </Link>
                                </li>
                            </ul>
                        </nav>
